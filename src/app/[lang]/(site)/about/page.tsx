              ...
              <div className="sticky top-32 p-8 rounded-3xl border border-[var(--border-subtle)] bg-[var(--bg-secondary)] shadow-lg shadow-black/5">
                ...
                <div className="space-y-6">
                  {siteSettings.phone && (
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[var(--text-primary)]">{dict.about.callUs}</p>
                  ...
                  {siteSettings.contactEmail && (
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[var(--text-primary)]">{dict.about.emailLabel}</p>
                  ...
                  {siteSettings.address && (
                    <div className="flex gap-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[var(--text-primary)]">{dict.about.office}</p>
                ...
                <div className="mt-8 pt-8 border-t border-[var(--border-subtle)] flex flex-col gap-4">
                  <Button asChild size="lg" className="w-full rounded-full">
                    <Link href={localePath(locale, 'contact')}>{dict.about.sendMessage}</Link>
                  </Button>
