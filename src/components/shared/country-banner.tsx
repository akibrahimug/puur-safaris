 ...
 */
export function CountryBanner({ currentLocale, targetLocale }: CountryBannerProps) {
  ...
  return (
    <div
      ...
      lang={targetLocale}
      aria-label={copy.cta}
      className="fixed top-20 inset-x-3 z-[60] mx-auto flex w-auto max-w-2xl items-center gap-3 rounded-2xl border border-stone-200/80 bg-white/95 px-4 py-3 text-stone-900 shadow-[0_12px_40px_rgba(0,0,0,0.14)] backdrop-blur-md dark:border-white/10 dark:bg-ink/95 dark:text-white sm:gap-4 sm:px-5"
    >
